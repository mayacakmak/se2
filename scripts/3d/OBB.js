...
Object.assign(OBB.prototype, {
	...
	*/
	clampPoint: function (point, result) {
		...
		var x = clamp(v1.dot(xAxis), - halfSize.x, halfSize.x);
		result.add(xAxis.multiplyScalar(x));

		var y = clamp(v1.dot(yAxis), - halfSize.y, halfSize.y);
		result.add(yAxis.multiplyScalar(y));

		var z = clamp(v1.dot(zAxis), - halfSize.z, halfSize.z);
	...
	*/
	intersectsOBB: function (obb, epsilon = Number.EPSILON) {
		...
		// This doesn't exist in THREE.js r73 so we have to write it ourselves
		//this.rotation.extractBasis(a.u[0], a.u[1], a.u[2]);
		extractBasis(this.rotation, a.u[0], a.u[1], a.u[2]);
		...
		extractBasis(obb.rotation, b.u[0], b.u[1], b.u[2]);
	...
	*/
	...
	applyMatrix4: function (matrix) {
		...
		setFromMatrix4(rotationMatrix, matrix);
		...
		this.rotation.copy(multiplyMatrix3(this.rotation, rotationMatrix));
