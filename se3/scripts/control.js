  ...
  */
  ...
  Control.updateControlPositions = function (update_svg = true) {
    ...
    if (kinematics) {
      ...
      //console.log(calcQuaternionDist(ik_target.quaternion, eePose.quaternion), ik_target.quaternion, eePose.quaternion);
      if (calcDist(ik_target.position, eePose.position) > 0.25 || calcQuaternionDist(ik_target.quaternion, eePose.quaternion) > 0.3) {
